...
const CONFIG = {
  ...
  pages: [
    ...
    },
    {
      ...
      users: [
        { discordId: "0", fallbackName: "Member 1" },
        { discordId: "0", fallbackName: "Member 2" },
        { discordId: "0", fallbackName: "Member 3" },
        { discordId: "0", fallbackName: "Member 4" },
        { discordId: "0", fallbackName: "Member 5" },
        { discordId: "0", fallbackName: "Member 6" },
      ],
    },
    {
      id: "page-xclsv",
      ...
      type: "grid",
      users: [
        { discordId: "0", fallbackName: "XCLSV 1" },
        { discordId: "0", fallbackName: "XCLSV 2" },
        { discordId: "0", fallbackName: "XCLSV 3" },
        { discordId: "0", fallbackName: "XCLSV 4" },
      ],
    },
    {
      id: "page-team",
      ...
      type: "grid",
      users: [
        { discordId: "0", fallbackName: "YYX Prime" },
        { discordId: "0", fallbackName: "YYX Member" },
        { discordId: "0", fallbackName: "YYX Elite" },
        { discordId: "0", fallbackName: "YYX Scout" },
      ],
    },
  ],
};
